  ...
  const features = [
    {
      ...
      description: 'Tell us your business idea in any language using voice or text',
      icon: Lightbulb,
    ...
    },
    {
      ...
      description: 'Get a comprehensive business plan generated by AI',
      icon: FileText,
      color: 'text-blue-600',
      bgColor: 'bg-blue-50',
      progress: 0,
    },
    {
      id: 'design-studio',
      title: 'Design Studio',
      description: 'Create logos, mockups, and visual content for your brand',
      icon: Palette,
    ...
    },
    {
      id: 'marketing',
      title: 'Marketing Hub',
      description: 'Generate marketing content and promotional materials',
      icon: Megaphone,
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Here's what we recommend to get your business started
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Use voice or text to tell us about your business concept</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg opacity-60">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-semibold">Generate your business plan</h4>
                  <p className="text-sm text-muted-foreground">AI will create a comprehensive business plan for you</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg opacity-60">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-semibold">Create your brand identity</h4>
                  <p className="text-sm text-muted-foreground">Design logos, business cards, and marketing materials</p>
                </div>
              </div>
              <Button variant="outline" disabled>
                Coming Next
